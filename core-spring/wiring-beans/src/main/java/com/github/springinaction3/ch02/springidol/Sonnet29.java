...
public class Sonnet29 implements Poem {
    protected final Logger logger = LoggerFactory.getLogger("Sonnet 29");
    
    private static String[] LINES = { "When, in disgrace with fortune and men's eyes,", "I all alone beweep my outcast state",
